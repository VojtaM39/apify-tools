...
router.addHandler<ListUserData>(Labels.List, async ({ request, log, maxRuns, crawler, client, runOffset }) => {
    ...
    const limit = Math.min(maxRuns - offset + runOffset, RUNS_PER_PAGE);
